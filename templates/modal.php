                    ...
                    <div class="mb-3">
                        ...
                        <div class="d-flex">
                            ...
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="userApproval" id="reject2"
                                    value="Reject">
            ...
            <div class="modal-body p-4">
                ...
                <form id="OwnerApprovalForm" action="payment.php" method="POST">
                    <div class="mb-3 row align-items-center">
                        ...
                        <div class="col-sm-7">
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="ownerApproval" id="approve"
                                    value="Approve">
                                <label class="form-check-label" for="approve">Approve</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="ownerApproval" id="reject"
                                    value="Reject">
