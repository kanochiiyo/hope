    ...
    <div class="card m-5 p-3 border-0 shadow rounded-4">
        <div class="card-body">
            ...
            <form action="" method="post">
                <div class="row mb-3">
                    <div class="mb-1 col-6">
                        <label for="address" class="form-label form-payment-label">Address Line</label>
                        <input type="text" class="form-control" id="address">
                    </div>
                    <div class="mb-1 col-6">
                        <label for="city" class="form-label form-payment-label">City</label>
                        <input type="text" class="form-control" id="city">
                    </div>
                </div>
                <div class="row mb-3">
                    <div class="mb-1 col-6">
                        <label for="state" class="form-label form-payment-label">State</label>
                        <input type="text" class="form-control" id="state">
                    </div>
                    <div class="mb-1 col-6">
                        <label for="postal" class="form-label form-payment-label">Postal Code</label>
                        <input type="text" class="form-control" id="postal">
                    </div>
                </div>
                <h5 class="fw-bold my-3">Payment Method</h5>
                ...
                <div class="row mb-3">
                    <div class="mb-1 col-6">
                        <label for="holderName" class="form-label form-payment-label">Cardholder's Name</label>
                        <input type="text" class="form-control" id="holderName">
                    </div>
                    <div class="mb-1 col-6">
                        <label for="cardNumber" class="form-label form-payment-label">Card Number</label>
                        <input type="text" class="form-control" id="cardNumber">
                    </div>
                </div>
                <div class="row mb-3">
                    <div class="mb-1 col-6">
                        <label for="expirity" class="form-label form-payment-label">Expirity</label>
                        <input type="text" class="form-control" id="expirity">
                    </div>
                    <div class="mb-1 col-6">
                        <label for="cvc" class="form-label form-payment-label">CVC</label>
                        <input type="text" class="form-control" id="cvc">
                    </div>
                </div>
                <div class="mb-3 row d-flex justify-content-between" style="margin: 0px 1px;">
