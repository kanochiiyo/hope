                    ...
                    <div class="col-3" style="background: #FAFBFF; border: 1px solid #5038ED; border-radius: 16px;">
                        <h1>Status Projek</h1>
                            <div class="position-relative w-full h-full" style="height: 100%;">
                                <div class="position-absolute" style="width:1px; background: black;min-height: 300px;left: 100px;"></div>
                                <div class="position-absolute d-flex align-items-center">
                                    <time style="width:95px">03-27</time>
                                    <div class="bg-success position-absolute" style="width: 12px;height: 12px; border-radius: 50%; border: 1px solid black; left: 94px;"></div>
